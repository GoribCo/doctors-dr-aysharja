...
export default function SiteHeader({ initialHome, doctorName, phone: configuredPhone }: Props) {
  ...
  const phone = text(home, 'phone', configuredPhone || '')
  ...
  return <header className="site-header">
    <div className="site-header-inner">
      ...
      <div className="header-actions">
        <select className="language-select" aria-label="Change language"
                value={lang}
